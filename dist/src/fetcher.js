...
const abi_1 = require("./entities/trades/curve/abi");
const pools_1 = require("./entities/trades/curve/pools");
const utils_1 = require("./entities/trades/curve/utils");
...
class Fetcher {
     ...
     */
    static fetchCurveFactoryPools(chainId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const modifiedArray = allPoolsArray.data.poolData.map(({ symbol, name, coins, address, implementation }) => {
                const tokens = coins.map(({ symbol, address, decimals }) => {
                    return {
                        symbol,
                        name: symbol.toUpperCase(),
                        address,
                        decimals: parseInt(decimals),
                        type: (0, utils_1.determineTokeType)(symbol),
                    };
                });
                return {
                    id: symbol,
