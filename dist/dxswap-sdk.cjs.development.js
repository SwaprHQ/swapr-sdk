...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.swapFee = new contracts.Contract(this.liquidityToken.address, IDXswapPair.abi, providers.getDefaultProvider(networks.getNetwork(tokenAmountA.token.chainId))).swapFee()["catch"](function () {
      return _30;
    });
    this.protocolFeeDenominator = new contracts.Contract(FACTORY_ADDRESS[tokenAmountA.token.chainId], IDXswapFactory.abi, providers.getDefaultProvider(networks.getNetwork(tokenAmountA.token.chainId))).protocolFeeDenominator()["catch"](function () {
      return FIVE;
    });
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_CACHE = CACHE$1) === null || _CACHE === void 0 ? void 0 : (_CACHE$tokens$0$addre = _CACHE[tokens[0].address]) === null || _CACHE$tokens$0$addre === void 0 ? void 0 : _CACHE$tokens$0$addre[tokens[1].address]) === undefined) {
      ...
      CACHE$1 = _extends(_extends({}, CACHE$1), {}, (_extends3 = {}, _extends3[tokens[0].address] = _extends(_extends({}, (_CACHE2 = CACHE$1) === null || _CACHE2 === void 0 ? void 0 : _CACHE2[tokens[0].address]), {}, (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(FACTORY_ADDRESS[tokenA.chainId], solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH), _extends2)), _extends3));
    }
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    try {
      ...
      !(inputAmount.token.equals(_this2.token0) || inputAmount.token.equals(_this2.token1)) ? "development" !== "production" ? invariant(false, 'TOKEN') : invariant(false) : void 0;
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    try {
      ...
      !(outputAmount.token.equals(_this4.token0) || outputAmount.token.equals(_this4.token1)) ? "development" !== "production" ? invariant(false, 'TOKEN') : invariant(false) : void 0;
  ...
  _proto.getLiquidityValue = function getLiquidityValue(token, totalSupply, liquidity, feeOn, kLast) {
    ...
    try {
      ...
      !(token.equals(_this6.token0) || token.equals(_this6.token1)) ? "development" !== "production" ? invariant(false, 'TOKEN') : invariant(false) : void 0;
      !totalSupply.token.equals(_this6.liquidityToken) ? "development" !== "production" ? invariant(false, 'TOTAL_SUPPLY') : invariant(false) : void 0;
      !liquidity.token.equals(_this6.liquidityToken) ? "development" !== "production" ? invariant(false, 'LIQUIDITY') : invariant(false) : void 0;
      !JSBI.lessThanOrEqual(liquidity.raw, totalSupply.raw) ? "development" !== "production" ? invariant(false, 'LIQUIDITY') : invariant(false) : void 0;
      ...
      var _temp6 = function () {
        if (!feeOn) {
          ...
          !!!kLast ? "development" !== "production" ? invariant(false, 'K_LAST') : invariant(false) : void 0;
...
function inputOutputComparator(a, b) {
  ...
  !(a.inputAmount !== undefined && a.outputAmount !== undefined) ?  invariant(false, 'UNDEFINED_A')  : void 0;
  !(b.inputAmount !== undefined && b.outputAmount !== undefined) ?  invariant(false, 'UNDEFINED_B')  : void 0;
...
function tradeComparator(a, b) {
  !(a.slippage !== undefined && b.slippage !== undefined) ?  invariant(false, 'UNDEFINED_NULL')  : void 0;
  !(a.route !== undefined && b.route !== undefined) ?  invariant(false, 'UNDEFINED_NULL')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade() {
    this.create = function (route, amount, tradeType) {
      try {
        ...
        !amount.token.equals(tradeType === exports.TradeType.EXACT_INPUT ? route.input : route.output) ? "development" !== "production" ? invariant(false, 'TOKEN') : invariant(false) : void 0;
        var trade = new Trade();
        trade.route = route;
        trade.tradeType = tradeType;
        trade.amount = amount;
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    !(this.outputAmount !== undefined) ?  invariant(false)  : void 0;
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    !!slippageTolerance.lessThan(ZERO) ?  invariant(false, 'SLIPPAGE_TOLERANCE')  : void 0;
    !(this.inputAmount !== undefined) ?  invariant(false)  : void 0;
  ...
  currentPairs, originalAmountIn, bestTrades) {
    ...
    try {
      var _exit2 = false;
      !(pairs.length > 0) ? "development" !== "production" ? invariant(false, 'PAIRS') : invariant(false) : void 0;
      !(maxHops > 0) ? "development" !== "production" ? invariant(false, 'MAX_HOPS') : invariant(false) : void 0;
      !(originalAmountIn === amountIn || currentPairs.length > 0) ? "development" !== "production" ? invariant(false, 'INVALID_RECURSION') : invariant(false) : void 0;
        ...
        function _temp12(_result) {
          ...
          var _temp10 = function () {
            if (amountOut.token.equals(tokenOut)) {
              return Promise.resolve(new Trade().create(new Route([].concat(currentPairs, [pair]), originalAmountIn.token), originalAmountIn, exports.TradeType.EXACT_INPUT)).then(function (_Trade$create) {
  ...
  currentPairs, originalAmountOut, bestTrades) {
    ...
    try {
      ...
      !(pairs.length > 0) ? "development" !== "production" ? invariant(false, 'PAIRS') : invariant(false) : void 0;
      !(maxHops > 0) ? "development" !== "production" ? invariant(false, 'MAX_HOPS') : invariant(false) : void 0;
      !(originalAmountOut === amountOut || currentPairs.length > 0) ? "development" !== "production" ? invariant(false, 'INVALID_RECURSION') : invariant(false) : void 0;
        ...
        function _temp20(_result3) {
          ...
          var _temp18 = function () {
            if (amountIn.token.equals(tokenIn)) {
              return Promise.resolve(new Trade().create(new Route([pair].concat(currentPairs), tokenIn), originalAmountOut, exports.TradeType.EXACT_OUTPUT)).then(function (_Trade$create2) {
