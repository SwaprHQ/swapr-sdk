 ...
 */
exports.FACTORY_ADDRESS = Object.assign(Object.assign({}, emptyAddressList), { [chains_1.ChainId.MAINNET]: _contracts_json_1.mainnet.factory, [chains_1.ChainId.RINKEBY]: _contracts_json_1.rinkeby.factory, [chains_1.ChainId.ARBITRUM_ONE]: _contracts_json_1.arbitrumOne.factory, [chains_1.ChainId.ARBITRUM_RINKEBY]: _contracts_json_1.arbitrumRinkebyTestnet.factory, [chains_1.ChainId.ARBITRUM_GOERLI]: _contracts_json_1.arbitrumGoerliTestnet.factory, [chains_1.ChainId.XDAI]: _contracts_json_1.xdai.factory });
/**
 * List of the Swapr Router contract address for each chain
 */
exports.ROUTER_ADDRESS = Object.assign(Object.assign({}, emptyAddressList), { [chains_1.ChainId.RINKEBY]: _contracts_json_2.rinkeby.router, [chains_1.ChainId.MAINNET]: _contracts_json_2.mainnet.router, [chains_1.ChainId.XDAI]: _contracts_json_2.xdai.router, [chains_1.ChainId.ARBITRUM_ONE]: _contracts_json_2.arbitrumOne.router, [chains_1.ChainId.ARBITRUM_RINKEBY]: _contracts_json_2.arbitrumRinkebyTestnet.router, [chains_1.ChainId.ARBITRUM_GOERLI]: _contracts_json_2.arbitrumGoerliTestnet.router });
/**
