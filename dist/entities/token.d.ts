...
export declare class Token extends Currency {
    ...
    static readonly ARB: Record<number, Token>;
    static readonly BUSD: Record<number, Token>;
    static readonly CAKE: Record<number, Token>;
...
export declare const ARB: Record<number, Token>;
export declare const BUSD: Record<number, Token>;
export declare const CAKE: Record<number, Token>;
