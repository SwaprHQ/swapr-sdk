...
class CoWTrade extends trade_1.Trade {
    constructor(params) {
        ...
        const approveAddress = (_a = GPv2Settlement[chainId]) === null || _a === void 0 ? void 0 : _a.address;
        (0, tiny_invariant_1.default)(approveAddress, 'Missing GPv2Settlement address');
        super({
            details: undefined,
            type: tradeType,
            inputAmount,
        ...
        this.quote = quote;
        // construct the order
        this.order = Object.assign(Object.assign({}, quote.quote), { validTo: parseInt(quote.quote.validTo), receiver: (_b = quote.quote.receiver) !== null && _b !== void 0 ? _b : quote.from });
