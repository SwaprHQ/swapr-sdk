...
export declare type Multicall2TryAggregateResult = {
    success: boolean;
...
export declare type UniswapV2TradeComputeTradesExactInParams = UniswapV2TradeComputeTradeCommonParams & Omit<UniswapV2TradeBestTradeExactInParams, 'platform'> & {
    originalAmountIn?: CurrencyAmount;
};
export declare type UniswapV2TradeComputeTradesExactOutParams = UniswapV2TradeComputeTradeCommonParams & Omit<UniswapV2TradeBestTradeExactOutParams, 'platform'> & {
