    ...
    static getQuote({ amount, quoteCurrency, tradeType, maximumSlippage = constants_2.maximumSlippage }, provider) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { fromTokenAmount, toTokenAmount } = yield (yield fetch((0, api_1.generateApiRequestUrl)({ methodName: api_1.RequestType.QUOTE, queryParams, chainId }))).json();
                ...
                if (tradeType === constants_1.TradeType.EXACT_OUTPUT) {
                    ...
                    const { toTokenAmount: toTokenAmountOutput, fromTokenAmount } = yield (yield fetch((0, api_1.generateApiRequestUrl)({ methodName: api_1.RequestType.QUOTE, queryParams, chainId }))).json();
