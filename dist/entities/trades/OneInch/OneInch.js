...
class OneInchTrade extends trade_1.Trade {
    constructor({ maximumSlippage, currencyAmountIn, currencyAmountOut, tradeType, chainId, approveAddress, estimatedGas, }) {
        super({
            details: undefined,
            type: tradeType,
    ...
    static getQuote({ amount, quoteCurrency, tradeType, maximumSlippage = constants_2.maximumSlippage }, provider) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { fromTokenAmount, toTokenAmount, estimatedGas } = yield (yield fetch((0, api_1.generateApiRequestUrl)({ methodName: api_1.RequestType.QUOTE, queryParams, chainId }))).json();
                gas = estimatedGas;
                ...
                if (tradeType === constants_1.TradeType.EXACT_OUTPUT) {
                    ...
                    const { toTokenAmount: toTokenAmountOutput, fromTokenAmount, estimatedGas, } = yield (yield fetch((0, api_1.generateApiRequestUrl)({ methodName: api_1.RequestType.QUOTE, queryParams, chainId }))).json();
                ...
                return new OneInchTrade({
                    ...
                    chainId,
                    approveAddress,
                    estimatedGas: bignumber_1.BigNumber.from(gas),
                });
            }
            catch (error) {
