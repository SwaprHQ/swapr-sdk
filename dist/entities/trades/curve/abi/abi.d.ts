...
export declare const CURVE_TRICRYPTO_ABI: ContractInterface;
export declare const CURVE_ETHXERC20_256_ABI: ContractInterface;
export declare const CURVE_METAUSD_ABI: ContractInterface;
export declare const CURVE_PLAIN_ABI: ContractInterface;
export declare const CURVE_PLAIN_ETH_ABI: ContractInterface;
export declare const CURVE_METABTC_ABI: ContractInterface;
export declare const CURVE_POOL_ABI_MAP: Record<string, ContractInterface>;
/**
