...
class CurveTrade extends trade_1.Trade {
    ...
    static getQuote({ currencyAmountIn, currencyOut, maximumSlippage, receiver = constants_1.AddressZero }, provider) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const tokenIn = (0, utils_3.getCurveToken)(wrappedTokenIn.address, chainId);
            const tokenOut = (0, utils_3.getCurveToken)(wrappedtokenOut.address, chainId);
            ...
            let routablePools = (0, utils_3.getRoutablePools)(curvePools, tokenIn, tokenOut, chainId);
            ...
            if (bestPoolAndOutputRes) {
                ...
                routablePools = curvePools.filter((pool) => pool.address.toLowerCase() === bestPoolAndOutputRes.poolAddress.toLowerCase());
            }
