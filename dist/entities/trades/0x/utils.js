...
function build0xApiUrl({ apiUrl, amount, maximumSlippage, chainId, buyToken, sellToken }) {
    const slippagePercentage = new percent_1.Percent(maximumSlippage.numerator, jsbi_1.default.multiply(maximumSlippage.denominator, jsbi_1.default.BigInt(100))).toFixed(4);
