 ...
 */
Currency.ETHER = new Currency(18, 'ETH', 'Ether', BURN_ADDRESS);
Currency.OPTIMISM_ETHER = new Currency(18, 'ETH', 'Ether', '0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000');
/**
 * Gnosis Chain native currency
 */
Currency.XDAI = new Currency(18, 'XDAI', 'xDAI', BURN_ADDRESS);
/**
 * Polygon PoS native currency
 */
Currency.MATIC = new Currency(18, 'MATIC', 'Matic', BURN_ADDRESS);
/**
 * BSC native currency
 */
Currency.BNB = new Currency(18, 'BNB', 'Binance Coin', BURN_ADDRESS);
