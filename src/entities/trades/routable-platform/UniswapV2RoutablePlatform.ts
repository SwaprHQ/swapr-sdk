...
const SUSHISWAP_FACTORY_ADDRESS: { [chainId: number]: string } = {
  ...
  [ChainId.BSC_MAINNET]: '0x126555dd55a39328F69400d6aE4F782Bd4C34ABb',
  [ChainId.GNOSIS]: '0xf78031CBCA409F2FB6876BDFDBc1b2df24cF9bEf',
  [ChainId.MAINNET]: '0xbACEB8eC6b9355Dfc0269C18bac9d6E2Bdc29C4F',
  [ChainId.OPTIMISM_MAINNET]: '0x9c6522117e2ed1fE5bdb72bb0eD5E3f2bdE7DBe0',
...
const SUSHISWAP_ROUTER_ADDRESS: { [chainId: number]: string } = {
  [ChainId.ARBITRUM_ONE]: '0x8A21F6768C1f8075791D08546Dadf6daA0bE820c',
  [ChainId.BSC_MAINNET]: '0x909662a99605382dB1E8d69cc1f182bb577d9038',
  [ChainId.GNOSIS]: '0x4F54dd2F4f30347d841b7783aD08c050d8410a9d',
  [ChainId.MAINNET]: '0x2E6cd2d30aa43f40aa81619ff4b6E0a41479B13F',
  [ChainId.OPTIMISM_MAINNET]: '0x8c32Fd078B89Eccb06B40289A539D84A4aA9FDA6',
  [ChainId.POLYGON]: '0x0aF89E1620b96170e2a9D0b68fEebb767eD044c3',
}
